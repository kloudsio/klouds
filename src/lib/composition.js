...
_.memo(Wrap.prototype, '_value', function () {
...
_.memo(Wrap.prototype, '_promise', function () {
  var value = this._value;
  return isGenerator(value)
    ? cocall(this._ctx, value)
...
_.memo(Wrap.prototype, '_generator', function () {
  var value = this._value;
  return isGenerator(value)
    ? value
